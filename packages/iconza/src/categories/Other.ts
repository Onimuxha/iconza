...
<svg width="1154" height="1154" viewBox="0 0 1154 1154" fill="none"
    ...
    },
    {
        name: "Windows10",
        category: "Other",
        keywords: ["windows", "microsoft", "microsoft windows", "os", "operating system"],
        svgContent: `
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512.02">
    <path fill="#0078D4" fill-rule="nonzero"
    ...
    },
    {
        name: "Windows11Logo",
        category: "Other",
        keywords: ["windows", "microsoft", "microsoft windows", "windows 11", "os", "operating system", "logo"],
        svgContent: `
...
<svg width="105" height="124" viewBox="0 0 105 124" fill="none" xmlns="http://www.w3.org/2000/svg">
    <g clip-path="url(#clip0_826_2)">
        <path fill-rule="evenodd" clip-rule="evenodd"
            d="M88 79.7998H99V123.8H0V79.7998H11V112.8H88V79.7998Z" fill="#BBBBBB" />
        <path
            d="M23 76.5L77 87.9L79.3 77.1L25.3 65.7L23 76.5ZM30.1 50.7L80.1 74L84.8 64L34.8 40.7L30.1 50.7ZM44 26.1L86.4 61.4L93.5 52.9L51.1 17.6L44 26.1ZM71.4 0L62.5 6.6L95.4 50.9L104.3 44.3L71.4 0ZM22 101.8H77V90.8H22V101.8Z"
            fill="#F58025" />
    </g>
    <defs>
        <clipPath id="clip0_826_2">
            <rect width="104.3" height="123.8" fill="white" />
        </clipPath>
    </defs>
</svg>
    `.trim(),
