...
export function HeroBackground({ className }: HeroBackgroundProps) {
  return (
    ...
    >
      {/* Soft color overlay */}
      <div className="absolute inset-0 bg-gradient-to-br from-indigo-500/50 via-transparent to-rose-500/15 blur-3xl" />
      <ElegantShape
        delay={0.3}
        width={600}
        height={140}
...
export type { HeroBackgroundProps, ElegantShapeProps };